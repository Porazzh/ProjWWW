document.addEventListener("DOMContentLoaded", function() {
  ...
  const guides = {
    ...
    "3": {
      title: "Interchange",
      description: "Interchange to duża mapa z centralnym punktem – centrum handlowym Ultra. Zanim wejdziesz na mapę, przygotuj się na intensywne walki PvP oraz PvE. Misje na Interchange często wymagają zdobycia przedmiotów w określonych sklepach lub strefach, więc warto znać mapę, aby nie zabłądzić. Pamiętaj o odpowiednim wyposażeniu – nocne misje mogą sprawić, że widoczność będzie bardzo ograniczona. Główne punkty zainteresowania: Ultra (centrum handlowe) – To serce mapy. Pełne niebezpiecznych przeciwników i cennych przedmiotów. Często odbywają się tu intensywne walki z innymi graczami. Uważaj na pułapki i zasadzki. Stacja benzynowa – Znajduje się na południu mapy i jest jednym z punktów, gdzie można znaleźć zasoby oraz sprzęt. Idealne miejsce do zaplanowania ataku lub ucieczki. Sklepy i magazyny – Przeszukuj je w poszukiwaniu sprzętu, broni i innych przydatnych przedmiotów. Często znajdują się tam ukryte zasoby. Przejścia – Na mapie są różne przejścia, zarówno otwarte, jak i zamknięte. Warto je poznać, aby znaleźć bezpieczną drogę do ekstrakcji. Kluczowe wskazówki: Nocne misje – Interchange w nocy może być bardzo trudne, ze względu na ograniczoną widoczność. Używaj latarek, noktowizji lub innych źródeł światła, aby poprawić widoczność. Dźwięki – W Interchange akustyka może zdradzić Twoją pozycję, szczególnie w dużych przestrzeniach, takich jak Ultra. Uważaj na dźwięki kroków i strzałów. Zasoby – Szukaj cennych przedmiotów, takich jak bronie, amunicja, elektronika i części do misji. Sklepy z elektroniką i odzieżowe są szczególnie bogate w zasoby. Zachowaj ostrożność – Mapka jest pełna różnych zagrożeń – nie tylko wrogów PvP, ale także NPC (Scavs), którzy mogą przechodzić przez różne strefy. Unikaj bycia zaskoczonym przez przeciwnika. Ekstrakcja: Zlokalizuj wyjścia z mapy. Pamiętaj, że Interchange jest dużą mapą i może być trudno znaleźć ekstrakcję, zwłaszcza przy niekorzystnych warunkach pogodowych lub w nocy. Mapy pomocnicze mogą pomóc Ci w wyznaczeniu drogi ucieczki.",
